...
function calc() {
  ...
  function getStaticInformation(selector, activeClass) {
    var elements = document.querySelectorAll(selector); //все дивы внутри родителя
...
function cards() {
  var FoodCard = /*#__PURE__*/function () {
    function FoodCard(src, alt, title, descr, price, parentSelector) {
  ...
  */
  ...
  axios.get('http://localhost:3000/menu').then(function (data) {
    return data.data.forEach(function (_ref) {
      var img = _ref.img,
          altimg = _ref.altimg,
          title = _ref.title,
          descr = _ref.descr,
...
/* harmony import */ var _servises_servises__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__(/*! ../servises/servises */ "./js/servises/servises.js");
...
function forms(formSelector, modalTimerId) {
  ...
  function bindPostData(form) {
    form.addEventListener('submit', function (ev) {
      ...
      var formData = new FormData(form); //собираем все данные из формы
      //если данные идут на сервер то в html inputa нужно всегда указывать name

      var json = JSON.stringify(Object.fromEntries(formData.entries())); //берем данные с формы, превр в массив массивов, после в обьект, после в джос 
      //request.send(formData); //без json
      //request.send(json);

      (0,_servises_servises__WEBPACK_IMPORTED_MODULE_9__.postData)('http://localhost:3000/requests', json).then(function (data) {
  ...
  function showThanksModal(message) {
    ...
    (0,_modal__WEBPACK_IMPORTED_MODULE_8__.modalOpen)('.modal', modalTimerId);
    ...
    setTimeout(function () {
      ...
      (0,_modal__WEBPACK_IMPORTED_MODULE_8__.closeModal)('.modal'); //и закрывается модалка вообще
    }, 40000);
  }
...
function closeModal(modalSelector) {
  ...
  modal.classList.remove('show'); //modal.classList.toggle('show'); //если есть убираем
...
function modalOpen(modalSelector, modalTimerId) {
  ...
  modal.classList.remove('hide'); //modal.classList.toggle('show'); //если нет добавляем
...
function modal(trigerSelector, modalSelector, modalTimerId) {
  var modalTrigger = document.querySelectorAll(trigerSelector),
...
/* harmony import */ var core_js_modules_web_dom_collections_for_each_js__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! core-js/modules/web.dom-collections.for-each.js */ "./node_modules/core-js/modules/web.dom-collections.for-each.js");
/* harmony import */ var core_js_modules_web_dom_collections_for_each_js__WEBPACK_IMPORTED_MODULE_3___default = /*#__PURE__*/__webpack_require__.n(core_js_modules_web_dom_collections_for_each_js__WEBPACK_IMPORTED_MODULE_3__);
/* harmony import */ var _timer__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./timer */ "./js/modules/timer.js");
...
function slider(_ref) {
  ...
  }); //для всех слайдов одинаковую ширину
  ...
  dotsList.forEach(function (el) {
    return el.addEventListener('click', function (ev) {
      ...
      currSliderNumber.innerText = (0,_timer__WEBPACK_IMPORTED_MODULE_4__.getZero)(slideIdx); //добавить 0 к текущему номеру

      makeDotsOpacity();
    });
  });
  nextBtn.addEventListener('click', function () {
    if (offset == deleteNotDig(width) * (slides.length - 1)) {
      //если максимум, перейти в начало
      offset = 0;
    } else {
    ...
    currSliderNumber.innerText = (0,_timer__WEBPACK_IMPORTED_MODULE_4__.getZero)(slideIdx);
    makeDotsOpacity();
  });
  prevBtn.addEventListener('click', function () {
    if (offset == 0) {
      //если минимум -- перейти в конец
  ...
  currSliderNumber.innerText = (0,_timer__WEBPACK_IMPORTED_MODULE_4__.getZero)(slideIdx);
  (0,_timer__WEBPACK_IMPORTED_MODULE_4__.getZero)(totalSliderCount.textContent);
  /*
  //вариант попроще
...
function tabs(tabsSelector, tabsContentSelector, tabsParentSelector, activeClass) {
  ...
  hideTabContent();
  showTabContent();
  tabsParent.addEventListener('click', function (ev) {
    //обертка со всеми табами делегир одинаковое событие от клика на все
...
function getZero(num) {
  if (num >= 0 && num < 10) {
    return "0".concat(num); //добавляется 0 если число однозначное
  } else {
    return num;
  }
}
...
function timer(id, deadline) {
  ...
  function setClock(selector, endtime) {
    ...
    function updateClock() {
      var t = getTimeRemaining(endtime); //обьект со всеми временами 
...
window.addEventListener('DOMContentLoaded', function () {
  var modalTimerId = setTimeout(function () {
    return (0,_modules_modal__WEBPACK_IMPORTED_MODULE_1__.modalOpen)('.modal', modalTimerId);
  }, 50000);
